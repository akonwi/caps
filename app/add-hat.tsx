...
export default function AddHat() {
  ...
  const handleSave = () => {
    ...
    // Emit event with new hat data
    import('@/utils/events').then(({ eventEmitter, HatEvents }) => {
      eventEmitter.emit(HatEvents.HAT_ADDED, { hat: newHat });
    });
      ...
      <View style={styles.form}>
        ...
        <View style={styles.buttons}>
          ...
          <TouchableOpacity
            ...
            onPress={handleSave}
          >
            <Text style={styles.saveButtonText}>Add Hat</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
